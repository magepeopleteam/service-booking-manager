<?php
   ...
   */
	...
	if (sizeof($all_sub_category) > 0) {
		?>
		<div class="_dShadow_7_mB_xs mpwpb_sub_category_area">
			...
			<div class="flexWrapJustifyBetween">
				<?php
					foreach ($all_sub_category as $sub_category_item) {
						...
						?>
						<div class="mpwpb_item_box mpwpb_sub_category_item dShadow_1" data-category="<?php echo esc_attr($category_name); ?>" data-sub-category="<?php echo esc_attr($sub_category_name); ?>">
