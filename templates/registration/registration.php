						...
						<div class="mp_sticky_area">
							<div class="_dLayout_dShadow_7_bRL_dFlex_fdColumn">
								<div class="registration_tab_item mptbm_service_tab mpActive">
									<img src="<?php echo esc_attr( MPWPB_PLUGIN_URL . '/assets/helper/images/service_icon.png' ); ?>" alt="<?php esc_attr_e( 'Services', 'bookingplus' ); ?>"/>
									<span><?php esc_html_e( 'Services', 'bookingplus' ); ?></span>
								</div>
								<div class="registration_tab_item mpwpb_date_time_tab mpDisabled">
									<img src="<?php echo esc_attr( MPWPB_PLUGIN_URL . '/assets/helper/images/date_time_icon.png' ); ?>" alt="<?php esc_attr_e( 'Date & Time', 'bookingplus' ); ?>"/>
									<span><?php esc_html_e( 'Date & Time', 'bookingplus' ); ?></span>
								</div>
								<div class="registration_tab_item mptbm_summary_tab mpDisabled">
									<img src="<?php echo esc_attr( MPWPB_PLUGIN_URL . '/assets/helper/images/summary_icon.png' ); ?>" alt="<?php esc_attr_e( 'Summary', 'bookingplus' ); ?>"/>
									<span><?php esc_html_e( 'Summary', 'bookingplus' ); ?></span>
								</div>
							</div>
