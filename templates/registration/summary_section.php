...
?>
	<div class="mpwpb_summary_area">
		...
		<div class="justifyBetween">
			<div class="flexWrap">
				<h5><?php esc_html_e( 'Service : ', 'service-booking-manager' ); ?></h5>&nbsp;
					...
					if ( sizeof( $ex_service_infos ) > 0 ) {
						foreach ( $ex_service_infos as $ex_service_info ) {
							...
							<div class="mpwpb_summary_item" data-extra-service="<?php echo esc_attr( $ex_service_info['name'] ); ?>">
								<div class="justifyBetween">
									<div class="flexWrap">
										<h5><?php esc_html_e( 'Extra Service : ', 'service-booking-manager' ); ?></h5>&nbsp;
		...
		?>
		<div class="dFlex">
			<h5><?php esc_html_e( 'Date & Time : ', 'service-booking-manager' ); ?></h5>&nbsp;
