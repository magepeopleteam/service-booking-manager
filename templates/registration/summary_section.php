...
?>
	<div class="mpwpb_summary_area">
		<h3 class="mB_xs"><?php esc_html_e( 'Order Summary', 'servicebookingmanager' ); ?></h3>
		<div class="divider"></div>
		<div class="justifyBetween">
			<div class="flexWrap">
				<h5><?php esc_html_e( 'Service : ', 'servicebookingmanager' ); ?></h5>&nbsp;
					...
					if ( sizeof( $ex_service_infos ) > 0 ) {
						foreach ( $ex_service_infos as $ex_service_info ) {
							...
							<div class="mpwpb_summary_item" data-extra-service="<?php echo esc_attr( $ex_service_info['name'] ); ?>">
								<div class="justifyBetween">
									<div class="flexWrap">
										<h5><?php esc_html_e( 'Extra Service : ', 'servicebookingmanager' ); ?></h5>&nbsp;
		...
		?>
		<div class="dFlex">
			<h5><?php esc_html_e( 'Date & Time : ', 'servicebookingmanager' ); ?></h5>&nbsp;
		...
		<div class="divider"></div>
		<div class="justifyBetween">
			<h3><?php esc_html_e( 'Total :', 'servicebookingmanager' ); ?>&nbsp;&nbsp;</h3>
