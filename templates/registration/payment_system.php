<?php
	...
	if ( sizeof( $payment_system ) > 1 ) {
		...
		<div class="mpwpb_payment_system_area mT">
			<h3><?php esc_html_e( 'Select Payment System', 'bookingplus' ); ?></h3>
				...
				<div class="allCenter">
					<?php if ( in_array( 'direct_order', $payment_system ) ) { ?>
						<div class="dLayout_xs min_200 mR" data-radio-check="direct_order" data-open-icon="fas fa-dot-circle" data-close-icon="far fa-circle">
							<h5 class="allCenter"><span data-icon class="far fa-circle mR_xs"></span><?php esc_html_e( 'Pay on service', 'bookingplus' ); ?></h5>
						</div>
					<?php } ?>
					<?php if ( in_array( 'woocommerce', $payment_system ) ) { ?>
						<div class="dLayout_xs min_200" data-radio-check="woocommerce" data-open-icon="fas fa-dot-circle" data-close-icon="far fa-circle">
							<h5 class="allCenter"><span data-icon class="far fa-circle mR_xs"></span><?php esc_html_e( 'To pay', 'bookingplus' ); ?></h5>
						</div>
					<?php } ?>
				</div>
			</div>
...
?>
	<div class="mpwpb_direct_order_info mT <?php echo esc_attr($current_payment_system=='direct_order'?'':'dNone'); ?>">
		<h3><?php esc_html_e( 'Billing Information', 'bookingplus' ); ?></h3>
		<div class="divider"></div>
		<label>
			<span class="min_150"><?php esc_html_e( 'Billing Name : ', 'bookingplus' ); ?></span>
			<input type="text" class="formControl mp_name_validation" name="mpwpb_bill_name" placeholder="<?php esc_attr_e( 'Billing Name Here....', 'bookingplus' ); ?>"/>
		</label>
		<label class="mT_xs">
			<span class="min_150"><?php esc_html_e( 'Billing E-Mail : ', 'bookingplus' ); ?></span>
			<input type="email" class="formControl" name="mpwpb_bill_email" placeholder="<?php esc_attr_e( 'Billing E-mail Here....', 'bookingplus' ); ?>"/>
		</label>
	</div>
