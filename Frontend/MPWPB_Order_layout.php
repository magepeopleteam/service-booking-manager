		...
		class MPWPB_Order_layout {
					...
					if ( ! is_wp_error( $order_id ) ) {
						...
						if ( $product ) {
							...
							if ( $item_id ) {
								...
								wc_add_order_item_meta( $item_id, esc_html__( 'Price ', 'servicebookingmanager' ), $price );
								wc_add_order_item_meta( $item_id, esc_html__( 'Date ', 'servicebookingmanager' ), esc_html( MPWPB_Function::date_format( $date ) ) );
								wc_add_order_item_meta( $item_id, esc_html__( 'Time ', 'servicebookingmanager' ), esc_html( MPWPB_Function::date_format( $date, 'time' ) ) );
								/*************************************/
								if ( sizeof( $extra_services ) > 0 ) {
									foreach ( $extra_services as $ex_service ) {
										...
										wc_add_order_item_meta( $item_id, esc_html__( 'Quantity ', 'servicebookingmanager' ), $ex_service['ex_qty'] );
										wc_add_order_item_meta( $item_id, esc_html__( 'Price ', 'servicebookingmanager' ), ' ( ' . MPWPB_Function::wc_price( $post_id, $ex_service['ex_price'] ) . ' x ' . $ex_service['ex_qty'] . ') = ' . MPWPB_Function::wc_price( $post_id, ( $ex_service['ex_price'] * $ex_service['ex_qty'] ) ) );
									}
								}
								/*************************************/
							...
							echo MPWPB_Function::get_service_text( $post_id ) . ' ' . esc_html__( ' not found', 'servicebookingmanager' );
						}
					}
					// }
				}
											...
											<div class="flexWrap">
												...
												<div class="col_6 col_xs_12">
													...
													<h4 class="justifyBetween">
														<span><?php esc_html_e( 'Total Bill : ', 'servicebookingmanager' ) ?></span>
			...
			public static function order_info( $attendee_id ) {
				if ( $attendee_id > 0 ) {
					...
					?>
					<h4><?php esc_html_e( 'Order details', 'servicebookingmanager' ); ?></h4>
					<div class="divider"></div>
					<ul class="mp_list">
						<li><strong class="min_100"><?php esc_html_e( 'Order ID:', 'servicebookingmanager' ); ?> :</strong>&nbsp;#<?php echo esc_html( $order_id ); ?></li>
						<li><strong class="min_100"><?php esc_html_e( 'Ticket No', 'servicebookingmanager' ); ?> :</strong>&nbsp;<?php echo MPWPB_Function::get_post_info( $attendee_id, 'mpwpb_pin' ); ?></li>
						<li><strong class="min_100"><?php echo MPWPB_Function::get_service_text( $post_id ) . ' ' . esc_html__( ' Date : ', 'servicebookingmanager' ); ?></strong>&nbsp;<?php echo MPWPB_Function::date_format( $date, 'full' ); ?></li>
						<li><strong class="min_100"><?php esc_attr_e( 'Booking Date : ', 'servicebookingmanager' ); ?></strong>&nbsp;<?php echo MPWPB_Function::date_format( $attendee_info->post_date, 'full' ); ?></li>
			...
			public static function service_info( $attendee_id ) {
				if ( $attendee_id > 0 ) {
					...
					?>
					<h4><?php echo MPWPB_Function::get_service_text( $post_id ) . ' ' . esc_html__( 'Information', 'servicebookingmanager' ); ?></h4>
					<div class="divider"></div>
					<ul class="mp_list">
						<?php if ( $category ) { ?>
						...
						<li><strong class="min_100"><?php esc_html_e( 'Price', 'servicebookingmanager' ); ?> :</strong>&nbsp;<?php echo wc_price( $price ); ?></li>
			...
			public static function ex_service_info( $item_id ) {
				...
				if ( sizeof( $ex_service_infos ) > 0 ) {
					?>
					<h4><?php echo esc_html__( 'Extra', 'servicebookingmanager' ) . ' ' . MPWPB_Function::get_service_text( $post_id ); ?></h4>
					<div class="divider"></div>
					<ul class="mp_list">
						<?php
			...
			public static function billing_info( $attendee_id ) {
				...
				?>
				<h4><?php esc_html_e( 'Billing information', 'servicebookingmanager' ); ?></h4>
				<div class="divider"></div>
				<ul class="mp_list">
					<?php if ( $billing_name ) { ?>
						<li><strong class="min_100"><?php esc_html_e( 'Name', 'servicebookingmanager' ); ?> : &nbsp;</strong><?php echo esc_html( $billing_name ); ?></li>
					<?php } ?>
					<?php if ( $email ) { ?>
						<li><strong class="min_100"><?php esc_html_e( 'E-mail', 'servicebookingmanager' ); ?> : &nbsp;</strong><?php echo esc_html( $email ); ?></li>
					<?php } ?>
					<?php if ( $phone ) { ?>
						<li><strong class="min_100"><?php esc_html_e( 'Phone', 'servicebookingmanager' ); ?> : &nbsp;</strong><?php echo esc_html( $phone ); ?></li>
					<?php } ?>
					<?php if ( $address ) { ?>
						<li><strong class="min_100"><?php esc_html_e( 'Address', 'servicebookingmanager' ); ?> : &nbsp;</strong><?php echo esc_html( $address ); ?></li>
					<?php } ?>
				</ul>
				<?php
			}
