...
if (!class_exists('MPWPB_Wc_Checkout_Shipping'))
{
    class MPWPB_Wc_Checkout_Shipping 
    {
        ...
        public function __construct()
        {
            ...
            add_action('admin_init', [ $this, 'save_mpwpb_wc_shipping_field_settings' ]);            
        ...
        {
            ?>
                <li class="tab-item" data-tabs-target="#mpwpb_wc_shipping_field_settings"><i class="dashicons dashicons-airplane text-primary"></i> Shipping Fields <i class="i i-chevron-right dashicons dashicons-arrow-right-alt2"></i></li>
            <?php
        }
        ...
        public function save_mpwpb_wc_shipping_field_settings()
        {
            // Save the
        }
