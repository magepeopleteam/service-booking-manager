		...
		class MPWPB_Date_Time_Settings {
			...
			public function date_time_settings( $post_id ) {
				...
				<div class="tabsItem mpwpb_settings_date_time" data-tabs="#mpwpb_settings_date_time">
					<h5><?php echo get_the_title( $post_id ) . ' ' . esc_html__( 'Date & Time Settings', 'bookingplus' ); ?></h5>
					<div class="divider"></div>
					<div class="mpTabs tabBorder">
						<ul class="tabLists">
							<li data-tabs-target="#mpwpb_date_time_general">
								<span class="fas fa-home"></span><?php esc_html_e( 'General', 'bookingplus' ); ?>
							</li>
							<li data-tabs-target="#mpwpb_date_time_schedule">
								<span class="far fa-clock"></span><?php esc_html_e( 'schedule', 'bookingplus' ); ?>
							</li>
							<li data-tabs-target="#mpwpb_date_time_off_day">
								<span class="fas fa-calendar-alt"></span><?php esc_html_e( 'Off Days & Dates', 'bookingplus' ); ?>
							</li>
						</ul>
						<div class="tabsContent tab-content">
							<div class="tabsItem" data-tabs="#mpwpb_date_time_general">
								...
								?>
								<label>
									<span class="max_200"><?php esc_html_e( 'Service Start Date', 'bookingplus' ); ?><span class="textRequired">&nbsp;*</span></span>
								...
								<div class="divider"></div>
								<label>
									<span class="max_200"><?php esc_html_e( 'Service end Date', 'bookingplus' ); ?><span class="textRequired">&nbsp;*</span></span>
								...
								<div class="divider"></div>
								<label>
									<span class="max_200"><?php esc_html_e( 'Time Slot Length', 'bookingplus' ); ?></span>
									<select class="formControl" name="mpwpb_time_slot_length">
										<option selected disabled><?php esc_html_e( 'Select time slot Length', 'bookingplus' ); ?></option>
										<option value="10" <?php echo esc_attr( $time_slot == 10 ? 'selected' : '' ); ?>><?php esc_html_e( '10 min', 'bookingplus' ); ?></option>
										<option value="15" <?php echo esc_attr( $time_slot == 15 ? 'selected' : '' ); ?>><?php esc_html_e( '15 min', 'bookingplus' ); ?></option>
										<option value="30" <?php echo esc_attr( $time_slot == 30 ? 'selected' : '' ); ?>><?php esc_html_e( '30 min', 'bookingplus' ); ?></option>
										<option value="60" <?php echo esc_attr( $time_slot == 60 ? 'selected' : '' ); ?>><?php esc_html_e( '1 Hour', 'bookingplus' ); ?></option>
										<option value="120" <?php echo esc_attr( $time_slot == 120 ? 'selected' : '' ); ?>><?php esc_html_e( '2 Hour', 'bookingplus' ); ?></option>
										<option value="180" <?php echo esc_attr( $time_slot == 180 ? 'selected' : '' ); ?>><?php esc_html_e( '3 Hour', 'bookingplus' ); ?></option>
									</select>
								</label>
								<div class="divider"></div>
								<label>
									<span class="max_200"><?php esc_html_e( 'Capacity per Session', 'bookingplus' ); ?></span>
							...
							<div class="tabsItem" data-tabs="#mpwpb_date_time_schedule">
								<table>
									<thead>
									<tr>
										<th><?php esc_html_e( 'Day', 'bookingplus' ); ?></th>
										<th><?php esc_html_e( 'Start Time', 'bookingplus' ); ?></th>
										<th><?php esc_html_e( 'To', 'bookingplus' ); ?></th>
										<th><?php esc_html_e( 'End Time', 'bookingplus' ); ?></th>
										<th colspan="3" style="background-color: #e3d3d3;"><?php esc_html_e( 'Break Time', 'bookingplus' ); ?></th>
									</tr>
									</thead>
									<tbody>
									<?php
							...
							<div class="tabsItem" data-tabs="#mpwpb_date_time_off_day">
								<table>
									<tr>
										<th><?php esc_html_e( 'Off Day', 'bookingplus' ); ?></th>
										<td colspan="2">
											<?php
									...
									<tr>
										<th><?php esc_html_e( 'Off Dates', 'bookingplus' ); ?></th>
										<td colspan="2">
											<div class="mp_settings_area">
												...
												<?php MPWPB_Layout::add_new_button( esc_html__( 'Add New Off date', 'bookingplus' ) ); ?>
			...
			public function time_slot_tr( $post_id, $day ) {
				...
				<tr>
					...
					<td class="textCenter"><strong><?php esc_html_e( 'To', 'bookingplus' ); ?></strong></td>
					...
					<td class="textCenter" style="background-color: #e3d3d3;"><strong><?php esc_html_e( 'To', 'bookingplus' ); ?></strong></td>
			...
			public function start_break_time_slot( $post_id, $day, $start_time, $end_time = '' ) {
				...
				<label>
					<select class="formControl" name="<?php echo $start_name_break; ?>">
						<option value="" <?php echo ! $start_time_break ? 'selected' : ''; ?>><?php esc_html_e( 'No Break', 'bookingplus' ); ?></option>
				...
				<label>
					<select class="formControl" name="<?php echo $end_name_break; ?>">
						<?php if ( $start_time_break == '' ) { ?>
							<option value="" selected><?php esc_html_e( 'No Break', 'bookingplus' ); ?></option>
						<?php } ?>
			...
			public function default_text( $day ) {
				if ( $day == 'default' ) {
					esc_html_e( 'Please select', 'bookingplus' );
				} else {
					esc_html_e( 'Default', 'bookingplus' );
				}
			}
			/*************************************/
