	...
	if (!class_exists('MPWPB_Wc_Checkout_Default')) {
		class MPWPB_Wc_Checkout_Default {
			...
			public function tab_item() {
				?>
				<li class="tab-item" data-tabs-target="#mpwpb_wc_checkout_settings">
					...
					<div>
						<form method="POST">
							...
							<table class="wc_gateways wp-list-table widefat striped">
								...
								<tr>
									<td>
										<label for="hide_checkout_order_additional_information">
											<span class="span-checkout-setting">Hide Order Additional Information Section</span>
										</label>
									</td>
								...
								<tr>
									<td>
										<label for="hide_checkout_order_review">
											<span class="span-checkout-setting">Hide Order Review Section</span>
										</label>
									</td>
