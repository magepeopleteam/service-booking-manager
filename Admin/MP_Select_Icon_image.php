		...
		class MP_Select_Icon_image {
					...
					<div class="mp_add_icon_popup mpPopup mpStyle" data-popup="#mp_add_icon_popup">
						<div class="popupMainArea fullWidth">
							<div class="popupHeader">
								<h2><?php esc_html_e( 'Select Icon', 'service-booking-manager' ); ?></h2>
									...
									if ( sizeof( $icons ) > 0 ) {
										...
										<div class="dFlex">
											<ul class="popupIconMenu">
												<li class="active" data-icon-menu="all_item"><?php esc_html_e( 'All Icon', 'service-booking-manager' ); ?>&nbsp;(<strong><?php echo esc_html( $total_icon ); ?></strong>)</li>
												<?php
			...
			public function add_multi_image( $name, $images ) {
				...
				<div class="mp_multi_image_area">
					...
					<?php //MPWPB_Layout::add_new_button( esc_html__( 'Add Image', 'service-booking-manager' ), 'add_multi_image', '_dButton_bgColor_1' ); ?>
				</div>
				<?php
			}
			//==============//
			public function add_icon_image( $name, $icon = '' ,$image='') {
				...
				<div class="mp_add_icon_image_area fdColumn">
					...
					<div class="mp_add_icon_image_button_area <?php echo esc_attr( $button_active_class ); ?>">
						<div class="flexEqual">
							<button class="_mpBtn_xs mp_image_add" type="button"><span class="fas fa-images"></span><?php esc_html_e( 'Image', 'service-booking-manager' ); ?></button>
							<button class="_mpBtn_xs mp_icon_add" type="button" data-target-popup="#mp_add_icon_popup"><span class="fas fa-plus"></span><?php esc_html_e( 'Icon', 'service-booking-manager' ); ?></button>
						</div>
					</div>
